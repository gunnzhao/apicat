...
<div class="row">
    ...
    <div class="col-xs-3">
        <div class="input-group">
            <input type="text" class="form-control" id="keyword" placeholder="API名称或URL">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <p class="text-right tools-bar">
                    <?php if ($has_permission): ?>
                    <a href="/markdown/edit?pro_key=<?php echo $project_info['pro_key']; ?>&doc_id=<?php echo $doc['id']; ?>" id="go-edit">&nbsp;&nbsp;编辑&nbsp;&nbsp;</a>
                    <?php endif; ?>
...
<div id="delDocModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-block" id="del-markdown-doc">确定删除</button>
            </div>
        </div>
    </div>
</div>
